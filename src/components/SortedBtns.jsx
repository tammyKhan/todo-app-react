...
const SortedBtns = ( {sortType, setSortType} ) => {
  return (
    <div class="md:w-2/3  flex gap-3 md:gap-8 items-center mt-11">
         <h3 class="lg:text-xl md:text-lg text-base font-bold text-white">Sort :-</h3>
         <div class="border-2 border-[#839FEE] rounded-3xl">
