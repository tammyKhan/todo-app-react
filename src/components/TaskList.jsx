...
const TaskList = ({task}) => {
  return (
          <div className="flex bg-[#1F0356] p-3 rounded-3xl">
            ...
            <div className="w-full">
              ...
              <div className="flex justify-between w-full">
               <div className="flex flex-col md:flex-row gap-3 md:items-center mt-2 text-[#839FEE]">
                <span className="text-sm">Added: <span className="createdAt">${task.createdAt}</span></span>
            ...
            <i className="fa-solid fa-pen-to-square text-[#BFAF1C] text-xl cursor-pointer hover:text-opacity-65 edit-icon"></i>
            <i className="fa-solid fa-trash text-[#FF5730] text-xl cursor-pointer hover:text-opacity-65 delete-icon"></i>
          </div>
              </div>
